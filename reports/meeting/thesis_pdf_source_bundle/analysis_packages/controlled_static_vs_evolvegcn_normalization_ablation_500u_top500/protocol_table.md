...
| fixed_scientific_settings.config.dataset_format |  | temporal | temporal_final_snapshot | intentional_difference |
...
| fixed_scientific_settings.config.head_type |  | mlp | static_mlp_readout | intentional_difference |
...
| fixed_scientific_settings.config.num_nodes | 500 | 500 | 500 | matched |
...
| fixed_scientific_settings.dataset_metadata.dataset_type |  | temporal_graph_sequences | temporal_graph_sequences | matched |
...
| fixed_scientific_settings.dataset_metadata.graph_positions | raw_physical_XYZ_before_feature_normalization | raw_physical_XYZ_before_feature_normalization | raw_physical_XYZ_before_feature_normalization | matched |
...
| fixed_scientific_settings.dataset_metadata.num_nodes | 500 | 500 | 500 | matched |
| fixed_scientific_settings.dataset_metadata.num_snapshots |  | 5 | 5 | matched |
