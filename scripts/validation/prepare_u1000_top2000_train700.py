#!/usr/bin/env python3
"""Preflight or bind exact U1000 Train700 splits to validated Top2000 data."""
...
from scripts.validation import validate_u1000_top2000_sparse_dataset as dataset_validator
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--top-n", type=int, default=2000, choices=SUPPORTED_TOP_N)
